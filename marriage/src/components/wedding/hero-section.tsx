  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center">
        ...
        <h1 className="font-serif text-4xl mt-8 leading-tight text-background md:text-7xl lg:text-8xl text-balance">
          Daniel 
          & 
          Nelly
        </h1>
        ...
        {/* <div className="mt-6 flex items-center gap-4 max-w-md">
          <p className="text-sm  text-background/80 ">
            Por tanto, dejará el hombre a su padre y a su madre, y se unirá a su mujer, y serán una sola carne. <br />Génesis 2:24
          </p>
        </div> */}

         {/* <a
          href="#rsvp"
          className="mt-10 border max-w-xl border-background/60 bg-background/10 px-10 py-3 text-xs uppercase tracking-[0.2em] text-background backdrop-blur-sm transition-colors hover:bg-background/20"
        >
         Por tanto, dejará el hombre a su padre y a su madre, y se unirá a su mujer, y serán una sola carne. <br />Génesis 2:24
        </a> */}
      </div>
